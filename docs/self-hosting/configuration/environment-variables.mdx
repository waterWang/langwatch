...
| `AZURE_BLOB_ACCOUNT_KEY` | Azure Storage account key. Required by — and only by — `AZURE_BLOB_AUTH_MODE=sharedKey` | — |
...
Three rules worth knowing before you configure it:
